...
| [ADR-0006](implemented/architecture/2026-08-17-0006-lock-sync-ready-schema-baseline.md) | Lock the sync-ready schema baseline (UUIDv7 + shared columns) | Implemented | architecture | Refines ADR-0002; supersedes master Appendix A §3 on `id` type; excludes tables owned by ADR-0003/0004/0005 |
| [ADR-0007](implemented/architecture/2026-08-18-0007-define-control-number-format-token-grammar.md) | Define the Control Number Format token grammar and per-year sequence scope | Implemented | architecture | Refines Core Engine PRD §9.4/§14; builds on ADR-0006 |
| [ADR-0008](implemented/architecture/2026-08-18-0008-define-template-variable-enumeration.md) | Define the Template Variable enumeration for Certificate Templates | Implemented | architecture | Refines Core Engine PRD §9.4/§9.10/§9.11/§14; builds on ADR-0004/0006/0007 |
